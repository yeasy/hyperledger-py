...
_REGISTERUSERREQ = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='affiliation', full_name='protos.RegisterUserReq.affiliation', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='registrar', full_name='protos.RegisterUserReq.registrar', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sig', full_name='protos.RegisterUserReq.sig', index=4,
